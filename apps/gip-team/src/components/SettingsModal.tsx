...
export default function SettingsModal() {
  ...
  const handleClose = () => {
    ...
    if (typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('embed') === 'settings') {
      window.parent?.postMessage({ type: 'xinp-close-app-settings', appId: 'gip' }, '*')
    }
  }
